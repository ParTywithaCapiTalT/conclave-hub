  ...
  if (isConnected && address) {
    return (
      <div className="glass p-5 sm:p-6 rounded-2xl text-center w-full">
        ...
        <p className="text-cyan-300 font-mono text-xs break-all px-2">
          {address}
        </p>
    ...
    <div className="space-y-3 w-full">
      {connectors.map((connector) => (
        <motion.button
          ...
          className="w-full bg-gradient-to-r from-[#22d3ee] to-cyan-400 hover:from-cyan-300 hover:to-[#eab308] text-[#0a0a1f] font-bold py-4 px-4 sm:px-6 rounded-2xl text-xs sm:text-sm uppercase tracking-widest transition-all duration-200 block text-center whitespace-normal"
        >
